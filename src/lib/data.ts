...
export const DISHES: Dish[] = [
  ...
  { id: "marsa-banana", name: "المرسة بالموز والعسل", nameEn: "Banana & Honey Marsa", category: "main", price: 35, image: "/dishes/kunafa.jpg", description: "مرسة حلوة بال bananas والسكر والعسل، طبق شعبي شهي ولا يُقاوَم.", isNew: true },
  { id: "marsa-fish", name: "المرسة بالسمك", nameEn: "Fish Marsa", category: "main", price: 50, image: "/dishes/foul.jpg", description: "مرسة بالسمك الطازب ومرق غني بالنكهة الشعبية الأصيلة.", isNew: true },
  { id: "areekah", name: "العريكة", nameEn: "Areekah", category: "main", price: 25, image: "/dishes/kunafa.jpg", description: "عريكة سعودية تقليدية بالتمر والعسل والسمن البلدي.", isNew: true },
  ...
  { id: "khameer-open-chicken", name: "الخمير المفتوت دجاج", nameEn: "Open Khameer Chicken", category: "main", price: 32, image: "/dishes/mandi-chicken.jpg", description: "خمير مفتوت مع دجاج ومرق، نكهة شعبية أصيلة.", isNew: true },
  ...
  { id: "pressed-chicken", name: "المظغوط دجاج", nameEn: "Pressed Chicken", category: "main", price: 35, image: "/dishes/mandi-chicken.jpg", description: "مظغوط دجاج بالأرز والخبز المحمّص، وجبة شهية ومشبعة.", isNew: true },
  { id: "zigni-meat", name: "الزقني لحم", nameEn: "Zigni Lamb", category: "main", price: 50, image: "/dishes/foul.jpg", description: "زقني لحم شعبي حار بالصلصة الحمراء والتوابل الخاصة.", isNew: true, spicy: true },
  { id: "zigni-chicken", name: "الزقني دجاج", nameEn: "Zigni Chicken", category: "main", price: 38, image: "/dishes/foul.jpg", description: "زقني دجاج شعبي حار بصلصة الطماطم والتوابل.", isNew: true, spicy: true },
  ...
  { id: "stew-meat", name: "إيدام لحم", nameEn: "Meat Stew", category: "main", price: 45, image: "/dishes/foul.jpg", description: "إيدام لحم غني بالخضار والمرق، مطهو على الطريقة التقليدية.", isNew: true },
  { id: "stew-chicken", name: "إيدام دجاج", nameEn: "Chicken Stew", category: "main", price: 35, image: "/dishes/foul.jpg", description: "إيدام دجاج بالخضار والصلصة الحمراء الشهية.", isNew: true },
  { id: "stew-vegetable", name: "إيدام خضار", nameEn: "Vegetable Stew", category: "main", price: 28, image: "/dishes/salad-fattoush.jpg", description: "إيدام خضار طازجة متنوعة بصلصة الطماطم والتوابل.", isNew: true },
