...
export const DISHES: Dish[] = [
  ...
  { id: "marsa-banana", name: "المرسة بالموز والعسل", nameEn: "Banana & Honey Marsa", category: "main", price: 35, image: IMG.dessert, description: "مرسة حلوة بال bananas والسكر والعسل، طبق شعبي شهي ولا يُقاوَم.", isNew: true },
  { id: "marsa-fish", name: "المرسة بالسمك", nameEn: "Fish Marsa", category: "main", price: 50, image: IMG.stew, description: "مرسة بالسمك الطازب ومرق غني بالنكهة الشعبية الأصيلة.", isNew: true },
